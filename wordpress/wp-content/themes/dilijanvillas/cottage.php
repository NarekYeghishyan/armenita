      ...
      <section class="hero" id="hero" aria-label="Intro">
        <div class="hero__parallax" data-parallax-layer="bg">
          ...
          <div class="hero__video-wrap">
            <?php $cottage_hero_video = trim((string) get_field('video_cot_vill')); ?>
            <video class="hero__video" autoplay muted loop playsinline preload="auto" aria-hidden="true"<?php echo $cottage_hero_video === '' ? ' hidden' : ''; ?>>
              <?php if ($cottage_hero_video !== '') : ?>
                <source src="<?php echo esc_url($cottage_hero_video); ?>" type="<?php echo esc_attr(dilijanvillas_get_video_mime_from_url($cottage_hero_video)); ?>" />
              <?php endif; ?>
            </video>
            ...
            <div class="stay-unit__actions">
              <form class="booking-selector booking-selector--popup-dates booking-selector--luxury" data-booking-form data-booking-nightly-usd="120">
                ...
                <div
                  ...
                  role="group"
                  aria-labelledby="cottage-booking-stay-dates-label"
                >
                  <div id="cottage-booking-stay-dates-label" class="booking-selector__label">
